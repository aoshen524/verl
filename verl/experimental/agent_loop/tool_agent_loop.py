...
class AgentData:
    ...
    def __init__(
        ...
        self.processor_output_data: Optional[dict[str, Any]] = None
...
class ToolAgentLoop(AgentLoopBase):
    ...
    async def _handle_pending_state(self, agent_data: AgentData, sampling_params: dict[str, Any]) -> AgentState:
        ...
        agent_data.processor_output_data = self.maybe_build_processor_output_data(
    ...
    async def _handle_generating_state(
        ...
        with simple_timer("generate_sequences", agent_data.metrics):
            output: TokenOutput = await self.server_manager.generate(
                ...
                processor_output_data=agent_data.processor_output_data,
            )
    ...
    async def _handle_processing_tools_state(self, agent_data: AgentData) -> AgentState:
        ...
        if new_images_this_turn:
            ...
            agent_data.processor_output_data = None
